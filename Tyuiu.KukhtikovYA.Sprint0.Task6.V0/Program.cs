using Tyuiu.KukhtikovYA.Sprint0.Task6.V0.Lib;

namespace Tyuiu.KukhtikovYA.Sprint0.Task6.V0;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Произведение элементов массива = " + DataService.SubstractionArray(arraynums));
        Console.ReadKey();
    }
}